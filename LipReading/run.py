...
sys.path.append("LipReading/Visual_Speech_Recognition_for_Multiple_Languages")
            ...
            with open("generated_subtitles.csv", 'w') as fw :
                ...
                for subt_id in os.listdir(args.data_filename) :
                    ...
                    for fl in filelist :
                        ...
                        try:
                            res = one_step_inference(lipreader,fl,args.landmarks_filename,args.dst_filename)
                        except:
